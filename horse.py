...
class Ui_MainWindow(object):
    ...
    def solve(self):
        ...
        # if self.next_flag:
        #     if self.a1.pixmap() == QtGui.QPixmap('white.png') and self.b1.pixmap() == QtGui.QPixmap('white.png') and self.c1.pixmap() == QtGui.QPixmap('white.png'):
        #         if self.a4.pixmap() == QtGui.QPixmap('black.png') and self.b4.pixmap() == QtGui.QPixmap('black.png') and self.c4.pixmap() == QtGui.QPixmap('black.png'):
        #             self.timer.stop()
        #     if self.turn == "white":
        #         choice, move_white = self.get_white_move()
        #         #print("White choice: ", choice, ", White Move: ", move_white)
        #         self.white_pieces.remove(choice)
        #         self.white_pieces.append(move_white)
        #         #print(self.white_pieces)
        #         #self.next_flag = False
        #         self.turn = "black"
        #     else:
        #         choice, move_black = self.get_black_move()
        #         #print("Black choice: ", choice, ", Black Move: ", move_black)
        #         self.black_pieces.remove(choice)
        #         self.black_pieces.append(move_black)
    ...
    def div_solve(self, first_piece:tuple, second_piece:tuple):
        if first_piece[0] == "a4" and first_piece[1] == "black" and second_piece[0] == "c4" and second_piece[1] == "black":
            # swap a4 -> c3
            #self.swap_pieces(("a4", "black"), "c3")
            self.moves.append(("a4", "black", "c3"))
            # swap c4 -> a3
            #self.swap_pieces(("a4", "black"), "a3")
            self.moves.append(("c4", "black", "a3"))
            # swap a3 -> c2
            #self.swap_pieces(("a4", "black"), "c2")
            ...
            # swap b1 -> a3
            #self.swap_pieces(("b1", "white"), "a3")
            self.moves.append(("b1", "white", "a3"))
            # swap a3 -> c4
            #self.swap_pieces(("a3", "white"), "c4")
            self.moves.append(("a3", "white", "c4"))
            # swap c3 -> b1
            #self.swap_pieces(("c3", "black"), "b1")
            ...
            # swap c2 -> a3
            #self.swap_pieces(("c2", "black"), "a3")
            self.moves.append(("c2", "black", "a3"))
            # swap c1 -> a2
            #self.swap_pieces(("c1", "white"), "a2")
            self.moves.append(("c1", "white", "a2"))
            # swap a2 -> c3
            #self.swap_pieces(("a2", "white"), "c3")
            ...
            # swap a1 -> c2
            #self.swap_pieces(("a1", "white"), "c2")
            self.moves.append(("a1", "white", "c2"))
            # swap b4 -> a2
            #self.swap_pieces(("b4", "black"), "a2")
            ...
            # swap c2 -> b4
            #self.swap_pieces(("c2", "white"), "b4")
            self.moves.append(("c2", "white", "b4"))
            # swap c3 -> a4
            #self.swap_pieces(("c3", "white"), "a4")
            ...
            # swap a2 -> c1
            #self.swap_pieces(("a2", "black"), "c1")
            self.moves.append(("a2", "black", "c1"))
            # swap a3 -> c2
            #self.swap_pieces(("a3", "black"), "c2")
            self.moves.append(("a3", "black", "c2"))
            # swap c2 -> a1
            #self.swap_pieces(("c2", "black"), "a1")
